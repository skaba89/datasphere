...
export const aoApi = {
  ...
  parSource: () => api.get('/appels-offres/par-source'),
  activite: () => api.get('/appels-offres/activite'),
...
export const dossiersApi = {
  ...
  genererIA: (id: string, data?: { typeSolution?: string }) => api.post(`/dossiers/${id}/generer-ia`, data ?? {}),
